<!-- HOMEBREWERY V3 SOURCE — paste into https://homebrewery.naturalcrit.com/ for the rendered book look.
     This is the editable "standard" version; Boss.html is the offline-readable render. -->

# Halthurax, the Goldwyrm Who Would Not Burn
##### The recurring boss, run at a glance · *A fallen gold-dragon guardian who decided death is the enemy. He never gloats — he grieves.*
...
{{note
##### Run These — Named Legendary & Lair Actions
...
**Hit Points**  :: 212
___
***Legendary Actions*** — 3/round, at the end of other creatures' turns.
:
...
:
***Wing of Ash (2).*** He beats wings of falling cinders. Creatures within 10 ft: DC 16 Dex, **2d6 bludgeoning + knocked prone**, and a 15-ft radius fills with **gray fog** (lightly obscured, fey-light snuffed) until init 20.
:
***Lair Actions — the Pyre's Heart*** (initiative 20).
:
***Drown the Light.*** One relit Pyre-Fount gutters dark unless an adjacent ally spends a reaction to shield it; that fount's advantage vs. Graying Breath is lost.
:
...
:
***Call the Grateful Dead (2).*** A beloved citizen of Ossuara throws itself between Halthurax and an attack, **negating it entirely** — and the party watches an "innocent" they came to save die for him.
:
***Lair Actions — the Throne-Vault, Ossuara*** (initiative 20).
:
***The Floor Remembers.*** The fused-soul floor births **2d6 skeletons** (or 1d4 wights) that act on his initiative.
:
***Portcullis of Ribs.*** A grate of grinding bone slams across one 10-ft passage (AC 17, 40 HP), splitting the party.
:
...
:
***Unmake (2, Phase 2+).*** *"Let me save you."* One creature he can see: DC 23 Con or **drop to 0 HP** (a death save, not death) as he folds it gently toward the hoard. **Countered by the Aegis, Pyre-Blade, and Soul-Lantern capstones.**
:
***Chorus Swell (2).*** The Choir sings a single rising note; he gains **advantage on saves** until his next turn and a fallen Choir-anchor reknits with 25 HP.
:
***Lair Actions — the Emberthrone*** (initiative 20).
:
***False Dawn.*** The half-built heaven blazes with counterfeit sunrise. Every non-hoard creature: DC 20 Con, **3d6 radiant** (half on save) and **blinded** until the end of its next turn.
:
***Gravity of the Source.*** The failing flame inhales. Each non-flying creature: DC 20 Str or **dragged 15 ft toward the Source and knocked prone**.
:
